...
createAnchorPeers(){
 ...
 configtxgen -profile ManufacturerProductionProfile -outputAnchorPeersUpdate ./channel-artefacts/tf-mfd-prd-anchor.tx -channelID mfd-prd-channel -asOrg teafarm
 configtxgen -profile ManufacturerProductionProfile -outputAnchorPeersUpdate ./channel-artefacts/tm-mfd-prd-anchor.tx -channelID mfd-prd-channel -asOrg tata

sleep 2

 echo "*===============Creating anchor peers for Manufacturer & Wharehouse===========*"
configtxgen -profile ManufacturerWharehouseProfile -outputAnchorPeersUpdate ./channel-artefacts/tm-mfd-whs-anchor.tx -channelID mfd-whs-channel -asOrg tata
configtxgen -profile ManufacturerWharehouseProfile -outputAnchorPeersUpdate ./channel-artefacts/ts-mfd-whs-anchor.tx -channelID mfd-whs-channel -asOrg tatastore

sleep 2

echo "*================Creating anchor peers for Wharehouse & Retailer================================*"
 configtxgen -profile WharehouseRetailerProfile -outputAnchorPeersUpdate ./channel-artefacts/ts-whs-rtlr-anchor.tx -channelID whs-rtlr-channel -asOrg tatastore
 configtxgen -profile WharehouseRetailerProfile -outputAnchorPeersUpdate ./channel-artefacts/bb-whs-rtlr-anchor.tx -channelID whs-rtlr-channel -asOrg bigbazar
