...
getOrderDetails(){
    ...
    sudo docker exec -it cli-retail-1 peer chaincode query -C whs-rtlr-channel -n basic -c '{"Args":["getOrderDetails","1"]}'
    sleep 4
}
