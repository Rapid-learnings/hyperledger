...
export declare class pmcc extends Contract {
    constructor();
    init(ctx: Context, initialStock: string): Promise<any>;
    ...
    updateStatusToInTransit(ctx: Context, orderNo: string): Promise<any>;
    updateStatusToDelivered(ctx: Context, orderNo: string): Promise<any>;
